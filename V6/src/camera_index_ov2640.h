    ...
    <body>
        <section class="main">
            <div id="logo">
                ...
                <button id="back" style="float:left;">BACK</button>
            </div>
            <div id="content">
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <div class="input-group" id="quality-group">
                            ...
                            <input type="range" id="quality" min="0" max="63" value="0" class="default-action">
                        ...
                        <div class="input-group" id="sharpness-group">
                            ...
                            <div class="range-min">-2</div>
                            <input type="range" id="sharpness" min="-2" max="2" value="0" class="default-action">
                            <div class="range-max">2</div>
                        </div>
